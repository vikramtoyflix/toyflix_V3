...
import { Sparkles, Package, Baby, Users, GraduationCap, Gamepad2 } from "lucide-react";
...
interface PromotionalCatalogViewProps {
  ...
  isRideOnView?: boolean; // New prop to indicate if this is showing ride-on toys
}
...
const PromotionalCatalogView = ({
  ...
  // Determine which toys to show and sort with out-of-stock toys last
  const filteredToys = useMemo(() => {
    const toysToSort = isRideOnView 
      ? toys // For ride-on view, show all ride-on toys passed from parent
      : (ageFilteredToys || []); // For regular view, use age-filtered toys with category ordering
  ...
  }, [isRideOnView, toys, ageFilteredToys]);
  ...
  return (
    <>
        ...
        <Alert className="mt-4 mb-6">
          <AlertDescription>
            <div className="flex items-center justify-between">
              <span>
                Browse our complete toy collection sorted by categories. Subscribe to a plan to get toys included in your monthly selection.
              </span>
      ...
      {!user && (
        <Alert className="mt-4 mb-6">
          <AlertDescription>
            <div className="flex items-center justify-between">
              <span>
                Browse our complete toy collection with category ordering. Sign in to subscribe to a plan and get toys delivered monthly.
              </span>
      ...
      {/* RESTORED: Age Filter Buttons - Only show for regular toys, not ride-on */}
      {!isRideOnView && (
        <div className="mb-6">
