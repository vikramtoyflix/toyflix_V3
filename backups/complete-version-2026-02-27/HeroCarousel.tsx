...
const heroSlides = [
  ...
  },
  {
    ...
    link: "/about",
    backgroundImage: "/lovable-uploads/14d1772e-d757-40e5-968f-2539da2e5e1.png",
  },
];
              ...
              <div className="container mx-auto px-4 sm:px-6 relative z-10">
                ...
                >
                  ...
                  <Button
                    ...
                    className="bg-gradient-to-r from-toy-coral to-toy-sunshine hover:from-toy-coral/90 hover:to-toy-sunshine/90 text-white font-outfit font-semibold px-6 py-3 rounded-full shadow-lg transition-all duration-200"
                  >
                    {slide.cta}
