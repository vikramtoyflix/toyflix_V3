...
const staticSlides = [
  ...
  {
    id: "static-3",
    image_url: "/lovable-uploads/14d1772e-d757-40e5-968f-2539da2e5e1.png",
                    ...
                    <div className="max-w-2xl">
                      ...
                      <div className="flex">
                        <Button
                          ...
                          className="bg-gradient-to-r from-toy-coral to-toy-sunshine hover:from-toy-coral/90 hover:to-toy-sunshine/90 text-white font-outfit font-semibold rounded-full shadow-md hover:shadow-lg"
                        >
                          How it works
