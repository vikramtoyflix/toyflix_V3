import { Search, Sparkles, Heart, Gift, Star } from "lucide-react";
...
const CatalogHeader = ({ searchQuery = "", onSearchChange }: CatalogHeaderProps) => {
  return (
      ...
      {onSearchChange && (
        <div className="relative max-w-xl mx-auto mt-6">
          ...
          <Input
            ...
            className={cn(
              "h-11 pl-11 rounded-xl border border-input bg-background",
              searchQuery ? "pr-12" : "pr-4"
            )}
            aria-label="Search toys by name"
          />
          {searchQuery && (
            <button
              type="button"
