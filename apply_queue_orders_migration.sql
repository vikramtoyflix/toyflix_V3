-- Apply queue_orders table migration if it doesn't exist
-- This will be executed on the production database
...
DROP POLICY IF EXISTS "Users can view own queue orders" ON queue_orders;
DROP POLICY IF EXISTS "Users can insert own queue orders" ON queue_orders;
DROP POLICY IF EXISTS "Users can update own queue orders" ON queue_orders;
DROP POLICY IF EXISTS "Admin can view all queue orders" ON queue_orders;
DROP POLICY IF EXISTS "Admin can update all queue orders" ON queue_orders;
DROP POLICY IF EXISTS "Admin can insert queue orders for any user" ON queue_orders;
...
SELECT 'Queue Orders table and functions created successfully!' as result;
