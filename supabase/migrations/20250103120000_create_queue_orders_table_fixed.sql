...
-- Policy: Admin users can view all queue orders (if user_roles table exists)
...
-- Policy: Admin users can update all queue orders (if user_roles table exists)
...
-- Policy: Admin users can insert queue orders for any user (if user_roles table exists)
...
-- Create a view for queue orders with user information (if custom_users table exists)
