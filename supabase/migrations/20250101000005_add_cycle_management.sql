...
GRANT EXECUTE ON FUNCTION public.get_user_cycle_status(UUID) TO authenticated;
GRANT EXECUTE ON FUNCTION public.is_selection_window_active(UUID) TO authenticated; 