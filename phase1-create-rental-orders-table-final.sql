-- =====================================================
-- PHASE 1: CREATE UNIFIED RENTAL ORDERS TABLE (FINAL)
-- =====================================================
...
CREATE TABLE rental_orders (
    ...
    -- Note: Cycle calculations will be done via functions instead of generated columns
...
BEGIN
    ...
    -- Clean up
    DELETE FROM rental_orders WHERE user_id = test_user_id;
